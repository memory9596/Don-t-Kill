...
public class PhoneSleepModeControllerHooker extends PowerKeeperLogSupportHooker {

    public PhoneSleepModeControllerHooker(LoadPackageParam loadPackageParam) {
        super(ClassConst.PHONE_SLEEP_MODE_CONTROLLER, loadPackageParam);
    }
